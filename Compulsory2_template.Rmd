...
# Crée les graphiques comme précédemment
...
plot8_small <- reduce_text_size(plot8)
plot9_small <- reduce_text_size(plot9)
plot10_small <- reduce_text_size(plot10)
plot11_small <- reduce_text_size(plot11)
plot12_small <- reduce_text_size(plot12)

plot_combined_three_col <- plot8_small + plot9_small + plot10_small +
  plot11_small + plot12_small +
