...
plot2<-ggplot(data, aes(x = ChestPainType, fill = factor(HeartDisease))) +
  ...
  labs(title = "Sex depending on the presence of the heart disease",
       x = "Sex",
       fill = "Presence of the heart disease") +
  theme_minimal()
plot3<-ggplot(data, aes(x = Sex, fill = factor(HeartDisease))) +
  geom_bar(position = "dodge") +
  labs(title = "Type of thoracic pain depending on the presence of the heart disease",
       x = "Type of thoracic pain", y = "Number of observations",
       fill = "Presence of the heart disease") +
  theme_minimal()
plot4<-ggplot(data, aes(x = FastingBS, fill = factor(HeartDisease))) +
  geom_bar(position = "dodge") +
  labs(title = "FastingBS depending on the presence of the heart disease",
       x = "FastingBS",
       fill = "Presence of the heart disease") +
  theme_minimal()
plot5<-ggplot(data, aes(x = RestingECG, fill = factor(HeartDisease))) +
  geom_bar(position = "dodge") +
  labs(title = "RestingECG depending on the presence of the heart disease",
       x = "RestingECG",
       fill = "Presence of the heart disease") +
  theme_minimal()
plot6<-ggplot(data, aes(x = ExerciseAngina, fill = factor(HeartDisease))) +
  geom_bar(position = "dodge") +
  labs(title = "ExerciseAngina depending on the presence of the heart disease",
       x = "ExerciseAngina",
       fill = "Presence of the heart disease") +
  theme_minimal()
plot7<-ggplot(data, aes(x = ST_Slope, fill = factor(HeartDisease))) +
  geom_bar(position = "dodge") +
  labs(title = "ST_Slope depending on the presence of the heart disease",
       x = "ST_Slope",
       fill = "Presence of the heart disease") +
  theme_minimal()
...
```{r, echo=FALSE}
plot8<-ggplot(data, aes(x = Cholesterol, fill = factor(HeartDisease))) +
  geom_density(alpha = 0.5) +
  labs(title = "Distribution of cholesterol depending on the presence of the heart disease", 
       x = "Cholesterol", fill = "HeartDisease") +
  theme_minimal()
plot9<-ggplot(data, aes(x = Age, fill = factor(HeartDisease))) +
  geom_density(alpha = 0.5) +
  labs(title = "Distribution of Age depending on the presence of the heart disease", 
       x = "Age", fill = "HeartDisease") +
  theme_minimal()
plot10<-ggplot(data, aes(x = RestingBP, fill = factor(HeartDisease))) +
  geom_density(alpha = 0.5) +
  labs(title = "Distribution of RestingBP depending on the presence of the heart disease", 
       x = "RestingBP", fill = "HeartDisease") +
  theme_minimal()
plot11<-ggplot(data, aes(x = MaxHR, fill = factor(HeartDisease))) +
  geom_density(alpha = 0.5) +
  labs(title = "Distribution of MaxHR depending on the presence of the heart disease", 
       x = "MaxHR", fill = "HeartDisease") +
  theme_minimal()
plot12<-ggplot(data, aes(x = Oldpeak, fill = factor(HeartDisease))) +
  geom_density(alpha = 0.5) +
  labs(title = "Distribution of Oldpeak depending on the presence of the heart disease", 
       x = "Oldpeak", fill = "HeartDisease") +
  theme_minimal()
grid.arrange(plot8,plot9,plot10,plot11,plot12, ncol=5)
```
...
legend("topright", inset = c(-0.35, 0), legend = c("Simple tree", "Pruning tree", "Bagging", "Random Forest", "AdaBoost"),
